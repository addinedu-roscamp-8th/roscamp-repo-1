...
from mycobot_kitchen_msgs.srv import GetCorrectedPose  # Request: raw_pose[6], Response: corrected_pose[6], applied, message
...
class BiasProviderNode(Node):
    def __init__(self):
        ...
        # params
        self.declare_parameter("bias_csv", "bias_err.csv")  # 항상 읽는 구조
