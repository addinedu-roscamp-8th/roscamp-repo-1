...
class PrecisionDockingServer(Node):
    ...
    def create_snapshot_goal(self):
        ...
        # [UPDATED 핵심] 목표 standoff 점까지의 "이동 벡터"(현재 로봇 기준)
        # move_vec = marker_pos - standoff * normal
        dx_base = tx - self.standoff_m * nx
        dz_base = tz - self.standoff_m * nz
        ...
        self.get_logger().info(
            ...
            f"(tx={tx:.3f}, tz={tz:.3f}, pose_yaw_err={theta:.3f}, yaw_rad_snap={yaw_rad_snap:.3f})"
        )
