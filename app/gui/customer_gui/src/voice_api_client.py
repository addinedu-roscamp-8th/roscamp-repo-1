...
def agent_voice(
    ...
    """
    POST /agent/voice — 오디오 1회: STT → 웨이크업 → (웨이크 시 펑션) → TTS.
    Returns: (result_dict, error_message). result 에 stt_text, wake, reply_text, tts_audio_base64 등 포함.
    """
...
def order_turn(
    ...
    """
    POST /agent/order_turn — 음성 주문 1턴.
